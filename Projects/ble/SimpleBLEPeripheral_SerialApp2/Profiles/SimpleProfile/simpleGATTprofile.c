...
// Simple Profile Service
		...
		{ { ATT_BT_UUID_SIZE, simpleProfilechar1UUID }, GATT_PERMIT_READ | GATT_PERMIT_WRITE, 0,
#ifdef HAL_UART_TRANS
				simpleProfileChar1
#else
				&simpleProfileChar1
...
bStatus_t SimpleProfile_GetParameter(uint8 param, void *value) {
	...
	case SIMPLEPROFILE_CHAR1:
#ifdef HAL_UART_TRANS
		VOID osal_memcpy( value, simpleProfileChar1, SIMPLEPROFILE_CHAR1_LEN ); //simpleProfileChar1 ��������
#else
		*((uint8*) value) = simpleProfileChar1; //simpleProfileChar1 �Ǳ���
#endif
		break;
...

{
	...
	if ( pAttr->type.len == ATT_BT_UUID_SIZE )
	{
		...
		switch ( uuid )
		{
			...
			{
#if 0
				if ( len != SIMPLEPROFILE_CHAR1_LEN ) //len ���ڶ�������˭������ ����simpleProfileAttrTbl֮characteristic 1֮Characteristic Value���Ⱦ�����  (��)
				{ //Ϊʲô�������� characteristic  (��)
					status = ATT_ERR_INVALID_VALUE_SIZE;
				}
#else	//�Է�(Central)�ô��ڷ�����ݸ���������(��ʱ��ΪԼ��С�ڵ���20 SIMPLEPROFILE_CHAR1_LEN)
				//����20��������ˣ���Ϊ�ҵ�attribute table�е�bufferֻ�� SIMPLEPROFILE_CHAR1_LEN ��
				//(Ҳ���Բ����жϣ���ֻ����20��һ��)
				//��������Central�˷��͵�ʱ���ж��£�����20���Ͳ���������ʾ���� ����ȷ����������˲�������
				//��������Central�˰Ѷ���20�ֽڵ�����ֶ�η��� ��ʱ�������������
				if ( len > SIMPLEPROFILE_CHAR1_LEN )//len ���ڶ�������˭������ ����simpleProfileAttrTbl֮characteristic 1֮Characteristic Value���Ⱦ�����  (��)
				{ //Ϊʲô�������� characteristic  (��)
					status = ATT_ERR_INVALID_VALUE_SIZE;
				}
			...
			if ( status == SUCCESS )
			{
				...
				VOID osal_memcpy( pCurValue, pValue, len );//�ٿ���
				//���len�ڱ��ļ���������Ҳ���õ�����GetParameter
				//�ڱ���������ص�����Ҳ���õ����䲻�ܴ������ǿ���ȫ�ֱ���
				//��������len���Ȳ���̫�������Ծ������ֵ SIMPLEPROFILE_CHAR1_LEN Ҳ����

				if( pAttr->pValue == simpleProfileChar1 )//����simpleProfileChar1����˭������
															  //simpleProfileAttrTbl֮characteristic 1֮Characteristic Value������
															  //(Ϊʲô��������characteristic 2��3��4��5���������������Щcharacteristic)
															  //�������������� simpleProfileChar1
				{
					notifyApp = SIMPLEPROFILE_CHAR1; //����char1��char3��������İɣ��ر���char5
				}
				else
			...
			case GATT_CLIENT_CHAR_CFG_UUID: //��ʲô�õ�? �ܷ�ִ�е� ?
	...
	{
		simpleProfile_AppCBs->pfnSimpleProfileChange( notifyApp ); //���ûص����� simpleProfileChangeCB()
	}
